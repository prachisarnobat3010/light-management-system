...
<head>
    ...
    <title>Worker- Bhavani lights</title>
              ...
              <div id="content">
                <div class="row" style="margin-bottom:20pt">
                        <button type="button" id="sidebarCollapse" class="navbar-btn">
							   ...
							   <h3 style="margin-left:10pt">Worker</h3>
                         
                </div>
                 <div class="row" style="margin-bottom:20pt">
                    <a type="button" class="btn btn-primary" data-toggle='modal' data-target='#myModal' style='display:inline'>Add worker</a>
                </div>
...
email_id" name="email_id" required> 
   ...
   <div class="form-group">
       ...
       <input type="text" class="form-control" id="email_id" placeholder="Enter 
user_type" name="user_type" required> 
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <input type="hidden" class="form-control" name="user_id" value="<?=$record1['userid']?>" required> 
...
email_id" name="email_id"  value="<?=$record1['email_id']?>" required> 
   ...
   <div class="form-group">
       ...
       <input type="text" class="form-control" id="email_id" placeholder="Enter 
user_type" name="user_type" value="<?=$record1['user_type']?>" required> 
  ...
  <div class="modal-dialog">
    ...
    <!-- Modal Header -->
      ...
      <div class="modal-body">
		...
		<h6>Do yo really want to delete worker?</h6>
      <div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <input type="hidden" class="form-control" name="user_id" value="<?=$record1['userid']?>" disabled> 
...
email_id" name="email_id"  value="<?=$record1['email_id']?>" disabled> 
   ...
   <div class="form-group">
       ...
       <input type="text" class="form-control" id="email_id" placeholder="Enter 
user_type" name="user_type" value="<?=$record1['user_type']?>" disabled> 
